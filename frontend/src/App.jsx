...
class App extends Component {
  ...
  refreshData = async () => {
    const catalogPromise = fetch('/api/catalog')
      .then(res => res.json())
      .then(result => compact(result));

    const rentalsPromise = fetch('/api/rent')
      .then(res => res.json())
      .then(result => compact(result));
                ...
                <div>
                  <div className='App__nav'>
                    ...
                    {/* <div className="App__promo">
                      <KubeconLogo size="22" />
                      Kubecon 2026 special offer! Get a <strong>50% discount</strong> on all movies today!
                    </div> */}
                  </div>
                  <TitleList
